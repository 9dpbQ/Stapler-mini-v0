...
AIの時代が来ています。ちょっと無責任ではありますが、素人でも案外アプリは作れます。こういうjsonを吐き出すだけの簡単なアプリならば現状のAIでも作れてしまいました。
作りたいアプリこそあれど、技術に自信がないそこのあなた！一緒にアプリの進捗を報告し合おうぜ！？知見を共有しようぜ〜！！
僕は今後はちゃんとしたStapler-mini、Karabiner-Elementsがせっかくオープンソースなのでそれを内包してファイル移動もいらないようにしたStaplerを作っていこうと思っています。
まぁ〜コードを見れば「あぁ〜なるほど…」となる技術力なので、あのアプリのコードを参考にするといいとか、そういう簡単なアドバイスをもらえるだけでもかなりありがたいし、なんならガジェットの話を雑談するだけでも制作の侘しさは紛れるし…[Discordコミュニティ](https://discord.gg/yVhZfsE2zS)に遊びに来てね〜
